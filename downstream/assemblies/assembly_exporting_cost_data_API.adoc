...
You can use the data export request API to obtain cost data for your sources in cost management, such as information about usage, tags, cost model assignments, and more. 

Using the API, you can export cost data easily to your external business integration (BI) tools to generate custom reports, and to view and compare your data in additional ways to those provided by the cost management application. 
