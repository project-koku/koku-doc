...
* Azure tags are exported to cost management in the cost export report configured in https://access.redhat.com/documentation/en-us/openshift_container_platform/4.3/html-single/getting_started_with_cost_management/index#configuring_an_azure_daily_export_schedule[Configuring a daily Azure data export schedule] in _Getting started with cost management_.
