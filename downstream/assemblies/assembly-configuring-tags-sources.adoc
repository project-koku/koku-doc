...
* AWS tags must be activated, and are then selected and exported to {product-title} in the Cost and Usage report. See _{link-activating-aws-tags}_ in the _Adding an Amazon Web Services (AWS) source__ guide for instructions.
