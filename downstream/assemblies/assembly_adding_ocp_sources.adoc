...
For OCP 4.5 and later, see xref:assembly_koku_cost_management_installing[].
====
...
* Collecting and packaging these reports to a tarball which is uploaded to cost management through {platform}.
