...
As you will complete some of the following steps in OpenShift Container Platform, and some steps in the cost management user interface, have both applications open in a web browser, as well as a terminal to access the command line interface (CLI).
...
* Operator Metering
+
Operator Metering is not deployed out of the box in OpenShift Container Platform. See See https://docs.openshift.com/container-platform/4.2/metering/metering-installing-metering.html[Installing Metering] in the OpenShift documentation for instructions to install metering from OperatorHub.
