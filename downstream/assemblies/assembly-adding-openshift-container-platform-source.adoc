...
The community `cost-mgt-operator` supported in OCP 4.3 and OCP 4.4 is deprecated. Though this cost operator functions with cost management in OCP 4.5, it is no longer supported. For installing this deprecated operator, see <LINK Installing 4.3 4.4 New Title>
