...
include::../modules/con_export_API_how_it_works.adoc[leveloffset=+1]

//include::../modules/configuring_AWS_bucket_for_API.adoc[]

include::../modules/exporting_cost_data_AWS_bucket.adoc[leveloffset=+1]

include::../modules/viewing_data_export_requests.adoc[leveloffset=+1]


include::../modules/ref_data_export_API_parameters.adoc[leveloffset=+1]
