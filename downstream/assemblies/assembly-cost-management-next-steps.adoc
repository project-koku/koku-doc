...
[role="_abstract"]
After adding your infrastructure and cloud sources, in addition to showing cost data by source, {product-title} will automatically show AWS and Azure cost and usage related to running your OpenShift Container Platform clusters on their platforms.
