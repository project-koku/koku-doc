...
[role="_abstract"]
To add a Google Cloud account to cost management, you must configure your Google Cloud to provide metrics, then add your Google Cloud account as a source from the {platform} user interface.
...
Add your Google Cloud source to cost management from the settings area at
