...
[NOTE]
====
You must have a Red Hat account user with Organization Administrator or Sources Administrator entitlements before you can add sources to {product-title}.
====
...
* {product-title} Google Cloud project.
