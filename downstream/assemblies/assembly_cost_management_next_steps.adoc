...
== Configure and organize tagging
...
* Plan your tagging strategy to organize your view of cost data
* Understand how cost management associates tags
* Configure tags and labels on your sources
* Learn more about tagging in https://access.redhat.com/documentation/en-us/openshift_container_platform/4.3/html-single/managing_cost_data_using_tagging/index[_Managing cost data using tagging_]. 

////

These topics are now in the tagging doc, can probably remove:
...
////
What should you learn or do with cost models?
