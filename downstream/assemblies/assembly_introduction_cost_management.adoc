...
After completing the setup described in this guide, you will be able to track cost and usage data for your AWS, Microsoft Azure, and OpenShift Container Platform environments.
