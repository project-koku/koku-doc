...
ifdef::context[:parent-context-of-assembly_template_assembly_a-collection-of-modules: {context}]
...
ifndef::context[]
[id="assembly_template_assembly_a-collection-of-modules"]
endif::[]
ifdef::context[]
[id="assembly_template_assembly_a-collection-of-modules_{context}"]
endif::[]
= TEMPLATE_ASSEMBLY_a-collection-of-modules
////
If the assembly covers a task, start the title with a verb in the gerund form, such as Creating or Configuring.
////

:context: assembly_template_assembly_a-collection-of-modules
...
////
ifdef::parent-context-of-assembly_template_assembly_a-collection-of-modules[:context: {parent-context-of-assembly_template_assembly_a-collection-of-modules}]
ifndef::parent-context-of-assembly_template_assembly_a-collection-of-modules[:!context:]
