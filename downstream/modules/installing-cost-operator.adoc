...
See, link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.7/html/operators/administrator-tasks#olm-inject-custom-ca_olm-configuring-proxy-support[_Injecting a custom CA certificate_] in the {openshift} documentation for details. 
====
