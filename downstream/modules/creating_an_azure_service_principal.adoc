...
====
. In the cloud.redhat.com *Sources* wizard, enter your Azure Active Directory application credentials and client secret.
...
----
+
. In the cloud.redhat.com *Sources* wizard, enter your Subscription ID click *Next*.
