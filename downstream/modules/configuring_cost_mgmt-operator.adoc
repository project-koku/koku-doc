openshift_container_platform/4.7// Module included in the following assemblies:
...
====
+
. In the {platform} *Sources* wizard, review the details and click *Finish* to add the OpenShift Container Platform cluster to cost management.
