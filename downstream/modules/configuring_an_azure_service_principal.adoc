...
----
+
. In the cloud.redhat.com *Sources* wizard, enter your *Subscription ID*.
...
----
+
. In the cloud.redhat.com *Sources* wizard, enter your Azure Active Directory *Tenant ID*, *Client ID*, and *Client Secret*, and click *Next*.
