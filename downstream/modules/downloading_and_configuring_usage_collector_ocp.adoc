...
====
+
. Copy the cluster identifier to enter into the cloud.redhat.com *Sources* area.
.. In the cloud.redhat.com platform, open the *Sources* menu (https://cloud.redhat.com/beta/settings/sources/) to begin adding your OpenShift source to cost management:
