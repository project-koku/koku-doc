...
username
----
.. In the *Value* field for the key `username`, enter the actual username for your authorized {platform} user account.
+
...
password
----
.. In the *Value* field for the key `password`, enter the actual password for your authorized {platform} user account.
+
