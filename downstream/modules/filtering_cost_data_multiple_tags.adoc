...
This example shows how an educational course provider that is running a lab environment on OpenShift Container Platform can use multiple filters to view cost information broken down by student and course.
...
////
What would you want to do next? Ask GPTE.
