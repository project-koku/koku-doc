...
* For more information on persistent volume claims, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.9/html/storage/understanding-persistent-storage[Understanding persistent storage].
