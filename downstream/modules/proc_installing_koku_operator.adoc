...
+
NOTE: The `cost-mgmt-operator` is deprecated in OpenShift Container Platform 4.5. Beginning with OpenShift Container Platform 4.5, you must install `koku-metrics-operator`.
